...
ts = adafruit_touchscreen.Touchscreen(
    ...
    board.TOUCH_YD,
    board.TOUCH_YU,
    calibration=((6691, 60304), (9232, 56895)),
    size=(480, 320),
)
...
def get_count_container():
    return {
        'one': {'five': 0, 'ten': 0, 'fifteen': 0, 'twenty': 0},
...
def calculate_scores():
    ...
    if count == 2:
        score_sheet = get_two_player_score(get_count_for_active_pos(1), get_count_for_active_pos(2))
    elif count == 3:
        score_sheet = get_three_player_score(
            get_count_for_active_pos(1), get_count_for_active_pos(2), get_count_for_active_pos(3)
        )
    elif count == 4:
        score_sheet = get_four_player_score(
            get_count_for_active_pos(1),
            get_count_for_active_pos(2),
            get_count_for_active_pos(3),
            get_count_for_active_pos(4),
        )
...
reset_button = Button(
    ...
    height=35,
    label='Reset',
    label_font=reset_font,
    label_color=reset_color_label,
    fill_color=reset_color_fill,
...
one_five_button = Button(
    ...
    label_color=one_color_label,
    fill_color=one_color_fill,
    style=Button.ROUNDRECT,
)
poker_group.append(one_five_button)
one_ten_button = Button(
    x=115,
    y=55,
    width=90,
    height=60,
...
one_score_button = Button(
    ...
    label='0',
    label_font=button_font,
    label_color=score_color_label,
    fill_color=score_color_fill_active,
    style=Button.ROUNDRECT,
)
...
two_five_button = Button(
    ...
    label='5',
    label_font=button_font,
    label_color=two_color_label,
    fill_color=two_color_fill,
    style=Button.ROUNDRECT,
)
poker_group.append(two_five_button)
two_ten_button = Button(
    x=115,
    y=120,
    width=90,
    height=60,
...
three_five_button = Button(
    ...
    label='5',
    label_font=button_font,
    label_color=three_color_label,
    fill_color=three_color_fill,
    style=Button.ROUNDRECT,
)
poker_group.append(three_five_button)
three_ten_button = Button(
    x=115,
    y=185,
    width=90,
    height=60,
...
three_score_button = Button(
    ...
    label_font=button_font,
    label_color=score_color_label,
    fill_color=score_color_fill_not_active,
    style=Button.ROUNDRECT,
)
...
four_five_button = Button(
    ...
    label='5',
    label_font=button_font,
    label_color=four_color_label,
    fill_color=four_color_fill,
    style=Button.ROUNDRECT,
)
poker_group.append(four_five_button)
four_ten_button = Button(
    x=115,
    y=250,
    width=90,
    height=60,
...
one_buttons = {five: one_five_button, ten: one_ten_button, fifteen: one_fifteen_button, twenty: one_twenty_button}
two_buttons = {five: two_five_button, ten: two_ten_button, fifteen: two_fifteen_button, twenty: two_twenty_button}
three_buttons = {
    five: three_five_button,
    ten: three_ten_button,
    fifteen: three_fifteen_button,
    twenty: three_twenty_button,
}
four_buttons = {five: four_five_button, ten: four_ten_button, fifteen: four_fifteen_button, twenty: four_twenty_button}
buttons = {one: one_buttons, two: two_buttons, three: three_buttons, four: four_buttons}
score_buttons = {one: one_score_button, two: two_score_button, three: three_score_button, four: four_score_button}
